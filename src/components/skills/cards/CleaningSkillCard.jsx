 ...
 * Features: 3-card battle layout (Instructions, Chest, Bounty List)
 */
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20" onClick={onEndBattle} style={{ zIndex: 50 }}>
                        <div className="flex items-center justify-center gap-8 relative max-w-[95vw] max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="flex-shrink-0">
                                <div className="relative w-[300px] bg-gradient-to-br from-cyan-900 via-slate-800 to-cyan-900 border-4 border-cyan-600 rounded-lg overflow-hidden" style={{ boxShadow: '0 0 40px rgba(0,150,150,0.5), inset 0 0 30px rgba(100,200,200,0.1)', height: '450px' }}>
                                    ...
                                    <div className="p-4 flex flex-col gap-4 h-[calc(100%-52px)]">
                                        ...
                                        <div className="bg-yellow-900/30 rounded-lg p-3 border border-yellow-600/50">
                                            <p className="text-yellow-300 text-sm text-center font-bold">⚠️ A Parent must verify your chore!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex-shrink-0" style={{ transform: 'scale(1.1)' }}>
                                <div className="relative w-[350px] bg-gradient-to-br from-amber-900 via-amber-800 to-amber-900 border-4 border-amber-600 rounded-lg overflow-hidden" style={{ boxShadow: '0 0 50px rgba(200,150,50,0.5), inset 0 0 40px rgba(255,200,100,0.1)', height: '450px' }}>
                                    ...
                                    <div className="relative flex flex-col items-center justify-center flex-1 p-4" style={{ height: 'calc(100% - 130px)' }}>
                                        ...
                                        <SafeImage src={mobSrc} alt={displayMobName} className="max-w-full max-h-full object-contain drop-shadow-[4px_4px_0_rgba(0,0,0,0.5)] animate-bob relative z-10" style={{ maxHeight: '200px' }} />
                                    ...
                                    <div className="bg-[#1a1a1a] p-4 border-t-4 border-amber-950 flex flex-col gap-2">
                                        ...
                                        <button onClick={() => setShowParentalModal(true)} className="w-full bg-green-600 hover:bg-green-500 text-white text-2xl font-bold py-3 rounded shadow-[0_4px_0_#166534] active:shadow-none active:translate-y-[4px] transition-all">✓ Complete!</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex-shrink-0">
                                <div className="relative w-[300px] bg-gradient-to-br from-amber-100 via-yellow-50 to-amber-50 border-4 border-amber-800 rounded-lg overflow-hidden" style={{ boxShadow: '0 0 40px rgba(0,0,0,0.6), inset 0 0 30px rgba(251,191,36,0.2)', height: '450px' }}>
                                    ...
                                    <div className="p-4 space-y-2 h-[calc(100%-100px)] overflow-y-auto">
                                        {[
                                            ...
                                            <div key={idx} className="bg-amber-900/20 border-2 border-amber-900/40 rounded p-2 flex items-center gap-2 hover:bg-amber-900/30 transition-colors">
                                                <span className="text-2xl">{item.reward}</span>
                                                <span className="text-stone-800 font-bold text-sm flex-1" style={{ fontFamily: '"Orbitron", sans-serif' }}>{item.chore}</span>
                                            </div>
                                        ))}
                                    </div>
                                    <div className="bg-gradient-to-t from-amber-900 to-amber-800 p-2 border-t-4 border-amber-950 relative">
                                        <div className="absolute inset-0 opacity-30 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
                                        <div className="text-center text-yellow-200 text-xs font-bold uppercase tracking-widest relative z-10">Pick One & Complete It!</div>
                                    </div>
                                </div>
                            </div>
                        </div>
