...
const PatternsSkillCard = ({
    ...
    const cardContent = (
        <div
            className={`skill-card-shell bg-[#2b2b2b] border-4 rounded-lg overflow-visible flex flex-col transition-all duration-500 ${isCenter ? `${appliedBorderEffect} ${!appliedBorderEffect ? borderClass : ''}` : 'border-stone-700'} w-[300px] h-[600px] relative`}
    ...
    if (isBattlingCenter) {
        ...
        return ReactDOM.createPortal(
            ...
            >
                ...
                {/* Click to exit text */}
                <div className="battle-exit-hint absolute bottom-6 left-1/2 -translate-x-1/2 text-yellow-400 text-2xl font-bold pointer-events-none" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
